...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        mal_splits = pickle.load(open('robustness_spec/seed_test_malicious/mutate_keep_one/pickles/splits.pickle', 'rb'))
        ...
        ### BENIGN
        benign_all_vec = pickle.load(open('robustness_spec/seed_test_benign/mutate_keep_one/pickles/vectors_all.pickle', 'rb'))
        benign_splits = pickle.load(open('robustness_spec/seed_test_benign/mutate_keep_one/pickles/splits.pickle', 'rb'))
        #benign_y_input = pickle.load(open('robustness_spec/seed_test_benign/mutate_keep_one/pickles/y_input.pickle', 'rb'))
