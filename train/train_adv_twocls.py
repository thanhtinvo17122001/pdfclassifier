...
def new_baseline_adv_train(model, train_ben, train_mal, test_ben, test_mal, model_name):
    ...
    ben_y_input = pickle.load(open(os.path.join(train_ben, 'y_input.pickle'), 'rb'), encoding="latin1")
    ben_vectors_all = pickle.load(open(os.path.join(train_ben, 'vectors_all.pickle'), "rb"), encoding="latin1")
    mal_y_input = pickle.load(open(os.path.join(train_mal, 'y_input.pickle'), 'rb'), encoding="latin1")
    mal_vectors_all = pickle.load(open(os.path.join(train_mal, 'vectors_all.pickle'), "rb"), encoding="latin1")
    ...
    ben_y_input_test = pickle.load(open(os.path.join(test_ben, 'y_input.pickle'), 'rb'), encoding="latin1")
    ben_vectors_all_test = pickle.load(open(os.path.join(test_ben, 'vectors_all.pickle'), "rb"), encoding="latin1")
    mal_y_input_test = pickle.load(open(os.path.join(test_mal, 'y_input.pickle'), 'rb'), encoding="latin1")
    mal_vectors_all_test = pickle.load(open(os.path.join(test_mal, 'vectors_all.pickle'), "rb"), encoding="latin1")
