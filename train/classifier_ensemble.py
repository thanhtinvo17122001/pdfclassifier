...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        ### MALICIOUS
        mal_all_vec = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_one/pickles/vectors_all.pickle', 'rb'), encoding="latin1")
        mal_splits = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_one/pickles/splits.pickle', 'rb'), encoding="latin1")
