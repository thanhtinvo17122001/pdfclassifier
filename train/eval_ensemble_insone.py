...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        ### MALICIOUS
        mal_x_input = pickle.load(open('robustness_spec/seed_test_malicious/mutate_insert_rootallbutone/pickles/x_input.pickle', 'rb'), encoding="latin1")
        mal_y_input = pickle.load(open('robustness_spec/seed_test_malicious/mutate_insert_rootallbutone/pickles/y_input.pickle', 'rb'), encoding="latin1")
        mal_all_vec = pickle.load(open('robustness_spec/seed_test_malicious/mutate_insert_rootallbutone/pickles/vectors_all.pickle', 'rb'), encoding="latin1")
        mal_ops_all = pickle.load(open('robustness_spec/seed_test_malicious/mutate_insert_rootallbutone/pickles/ops_all.pickle', 'rb'), encoding="latin1")
        mal_ops_all_bk = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_two/pickles/ops_all.pickle', 'rb'), encoding="latin1")
        sha1_pred = {}
        ###
        ...
        ###
        #vidx_sha1 = {}
        for sha1 in list(mal_ops_all_bk.keys()):
            sha1_pred[sha1] = 0
            #for rd in range(42):
            #    sha1_pred[sha1][rd] = 0
        ...
        print('allseeds num:', len(list(sha1_pred.keys())))
        print('vidx num:', len(y_pred))
        # sequence doesn't matter here.
        seed_idx = 0
        allseeds = list(sha1_pred.keys())
        rd = 0
        ...
        incorrect = 0
        #print sha1_pred
        for sha1, pred in sha1_pred.items():
            total += 1
            if pred == 0:
                incorrect += 1
        ...
        # use two deletion vectors to evaluate one deletion
        ### MALICIOUS
        mal_x_input = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_two/pickles/x_input.pickle', 'rb'), encoding="latin1")
        mal_y_input = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_two/pickles/y_input.pickle', 'rb'), encoding="latin1")
        mal_all_vec = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_two/pickles/vectors_all.pickle', 'rb'), encoding="latin1")
        mal_ops_all = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_two/pickles/ops_all.pickle', 'rb'), encoding="latin1")
        sha1_pred = {}
        #vidx_sha1 = {}
        for key, item in mal_ops_all.items():
            sha1, sub1, sub2 = item
        ...
        ### MALICIOUS
        mal_x_input = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_three/pickles/x_input.pickle', 'rb'), encoding="latin1")
        mal_y_input = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_three/pickles/y_input.pickle', 'rb'), encoding="latin1")
        mal_all_vec = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_three/pickles/vectors_all.pickle', 'rb'), encoding="latin1")
        mal_ops_all = pickle.load(open('robustness_spec/seed_test_malicious/mutate_delete_three/pickles/ops_all.pickle', 'rb'), encoding="latin1")
        sha1_pred = {}
        for key, item in mal_ops_all.items():
