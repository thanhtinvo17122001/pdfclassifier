...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        ### MALICIOUS
        mal_x_input = pickle.load(open('robustness_spec/seed_test_malicious/mutate_keep_one/pickles/x_input.pickle', 'rb'), encoding="latin1")
        mal_y_input = pickle.load(open('robustness_spec/seed_test_malicious/mutate_keep_one/pickles/y_input.pickle', 'rb'), encoding="latin1")
        mal_all_vec = pickle.load(open('robustness_spec/seed_test_malicious/mutate_keep_one/pickles/vectors_all.pickle', 'rb'), encoding="latin1")
        mal_ops_all = pickle.load(open('robustness_spec/seed_test_malicious/mutate_keep_one/pickles/ops_all.pickle', 'rb'), encoding="latin1")
        sha1_pred = {}
        #vidx_sha1 = {}
        ...
        for key, obj in feat_trie._root.children.items():
